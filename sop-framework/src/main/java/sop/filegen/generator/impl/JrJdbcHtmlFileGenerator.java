...
public class JrJdbcHtmlFileGenerator extends BaseFileGenerator {
    ...
    public JrJdbcHtmlFileGenerator(DataSource ds) {
        this.ds = ds;
    }
    ...
    protected GenResult generateFile(GenRequest request) throws FileGenerationException {
        ...
        try {
            ...
            String outFile = FileGeneratorUtils.getReportOutputFullPath(getOutputFolder(), reportFileName, ".html");
            String outFile2 = FileGeneratorUtils.getReportOutputFullPath(getOutputFolder(), reportFileName + "_barcode", ".html");
            JrReportEngine instance = JrReportEngine.getInstance();
            instance.setDataSource(ds);
            outFile = instance.exportHtmlWithSQL(request.getReportId(), FileGeneratorUtils.getParamMap(request), outFile);
